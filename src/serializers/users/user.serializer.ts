...
export const userCreateRequestSerializer: SchemaOf<IUserCreateRequest> = yup
  ...
  .shape({
    ...
    address: yup.object().shape({
      ...
      zip_code: yup
        .string()
        .length(8, "O CEP deve conter 8 digitos")
        .required(),
...
export const userUpdateRequestSerializer: SchemaOf<IUserUpdateRequest> = yup
  .object()
  .shape({
...
export const userWithAddressResponseSerializer: SchemaOf<IUserWithAddressResponse> =
  yup.object().shape({
...
export const listUsersResponseSerializer: SchemaOf<IUserWithAddressResponse[]> =
  yup.array(userWithAddressResponseSerializer);
...
export const userCompleteResponseSerializer: SchemaOf<IUserCompleteResponse> =
  yup.object().shape({
    id: yup.string().required(),
    name: yup.string().required(),
    email: yup.string().email().required(),
